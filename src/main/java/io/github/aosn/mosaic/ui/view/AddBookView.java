 ...
 * <ul>
 * <li>{@link #ATTR_BOOK_ADD} - A {@link io.github.aosn.mosaic.domain.model.catalog.ReleasedBook} object</li>
 * </ul>
 *
 * @author mikan
 * @since 0.3
...
public class AddBookView extends CustomComponent implements View {
    ...
    private Layout createAddStockLayout(ReleasedBook releasedBook) {
        ...
        Label isbnLabel = new Label(releasedBook.getIsbn());
        ...
        NumberField pagesField = new NumberField("Page count", releasedBook.getPageCount());
        ...
        mediaTypeComboBox.setValue(releasedBook.isEBook() ? Stock.MediaType.KINDLE : Stock.MediaType.PAPER);
        ...
        Button submitButton = new Button("Add book", e -> {
            ...
            try {
                Stock stock = Stock.builder()
                        ...
                        .isbn(Stock.normalizeIsbn(releasedBook.getIsbn()))
                        .bookName(titleField.getValue())
                        .publishDate(publishedDate.getValue())
                        .pages(pagesField.getValueAsInt())
                        ...
                        .thumbnailUrl(releasedBook.getThumbnailUrl())
                        .createdTime(now)
                        .updatedTime(now)
                        .build();
